...
public class ExOM {
    ...
    public ExOM toMapOfFields(List<String> list){
    	this.fields = list;
    	return this;
    ...
    private Object readExcelContent(final Row row, final Map<String, Integer> cells) throws Throwable {
       ...
       for(String field:fields) {
    	   if (cells.get(field) != null) {
    		   Cell cell = row.getCell(cells.get(field));
    		   map.put(field, getCellValue(cell));
           }
